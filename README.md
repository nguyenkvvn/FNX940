...
Geometry that was referenced from the FNS940 model by TMS includes but is not limited to: magazine button cut-out, magazine button spring relief, hammer pin location.
...
## Instructions
_Instructions can be found in the rich-text PDF included._
